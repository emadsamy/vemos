...
const Profile = ({}) => {
    const { register, reset, setValue, handleSubmit, watch, control, formState: { errors } } = useForm();
                                    ...
                                    <form onSubmit={handleSubmit(onSubmit)}>
                                        <div className={classes.formGroup}>
                                            <div className={classes.fgFlexable}>
                                                ...
                                                <div>
                                                    <Cleave placeholder="Enter Price"
                                            ...
                                            <div className={classes.fgFlexable}>
                                                ...
                                                <div>
                                                    <Controller
                                                        name="email"
                                                        control={control}
                                                        render={({ field }) => <input {...field} {...register('email', {required: 'Email is required to complete your transiction'})} placeholder="example@example.com" 
                                        ...
                                        <Button disabled={formStatus} variant="success" type="submit">Transfer Now</Button>
                                    </form>
                                </TabPanel>
                            </div>
                        </div>
